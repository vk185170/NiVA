...
class NiVA extends ActivityHandler {
    ...
    async sendSuggestedActions(context) {
        var suggestions = MessageFactory.suggestedActions(['Incident Management Support', 'Fix Terminal Faults', 'I have some Questions', 'I have some Feedback'], 'How may I enlighten your day with?');
